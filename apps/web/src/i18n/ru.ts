...
const RU = {
  ...
  "kanban.planner-up": "Выше",
  "kanban.planner-down": "Ниже",
  "kanban.planner-order-title": "Порядок на таймере:",
  ...
  "dial.start-blocked": "Старт отклонён: в плане дня нет ни одной задачи «В работе». Верни карточку на доску и попробуй снова.",
